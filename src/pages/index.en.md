...
id: '01'
title: "Museal Guide"
description: "Museal guide index"
templateKey: home
tags:
  - web
lang: en
...
<img src="../img/tapisserie_de_bayeux_ok.jpg" height="400" alt="Bayeux tapestry showcase">
...
The guide has different operating modes (each can be activated by a button on the frame):
...
+ image (tactile display of the work of art with possibility of modifications), etc.
The frame is the interface that will allow you to perceive, by exploring (freely or guided) with a finger placed on your joystick, a simplified, but interactive tactile representation of the information displayed on the screen. This performance will be accompanied by an ad hoc audio description.

<div align="center">

![Modele avec une carte](../img/index_fig1.png)  |![Modele avec un detail de la tapisserie](../img/index_fig2.png) | ![Premier prototype](../img/index_fig3.jpg)
-------------------------|-------------------------|-------------------------
...
![Map of a museum level displayed on the Museal Guide](../img/index_fig4.png)
<div align = "center"> Figure 3. Plan of a museum level displayed on the Museum Guide </div>
...
![Scene 38 of the Bayeux Tapestry](../img/index_fig4_a.jpg) |![A haptic representation of the wind in the sail and the wave ripple](../img/index_fig4_b.png)
------------------------- | ------------------------ -
Figure 4. a) Model with a map | b) a haptic representation of the wind in the sail and the wave ripple
</div>